      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-muted-foreground text-lg">
            Bridging the gap between complex technology and business growth with
            ...
            <div className="relative z-10 space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  At OCP Nexspace, we are more than just a software house; we
                  are your strategic partner. We specialize in delivering
                  high-performance, scalable, and intelligent software solutions
                ...
                <div className="absolute bottom-8 left-8 right-8">
                  <div className="bg-white/10 backdrop-blur-md border border-white/10 p-6 rounded-2xl">
                    <p className="text-white font-medium text-lg">
                      "We build systems that not only solve problems but create
                      new opportunities."
                    </p>
                  </div>
                </div>
